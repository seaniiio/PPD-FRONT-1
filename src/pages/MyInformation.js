...
function MyInformation() {
  ...
  //openModal함수가 호출되면 modalOpen이 false로 변경된다
    ...
    function infoFetch() {
      ...
      .then((response) => {
        console.log("내 정보 확인 요청 성공");
        console.log("response:", response);
        setUserInfo(response); // userInfo = response
      })
    }
    ...
    return (
        ...
        {/* backend 연결 후에 response 콘솔찍어서 확인한 뒤에 userInfo.name 넣기 */}
          <p><InformationText>이름<ShowInformation>{}</ShowInformation></InformationText><div className={editButtonShow ? "smallEditButtonShow" : "smallEditButtonHide"} onClick={openEditModal}>수정하기</div></p>
          <p><InformationText>이메일<ShowInformation>InPlatform@gamil.com</ShowInformation></InformationText></p>
          <p><InformationText>비밀번호<ShowInformation>123123</ShowInformation></InformationText><div className={editButtonShow ? "smallEditButtonShow" : "smallEditButtonHide"} onClick={openEditModal}>수정하기</div></p>
          <p><InformationText>나이<ShowInformation>100</ShowInformation></InformationText><div className={editButtonShow ? "smallEditButtonShow" : "smallEditButtonHide"} onClick={openEditModal}>수정하기</div></p>
